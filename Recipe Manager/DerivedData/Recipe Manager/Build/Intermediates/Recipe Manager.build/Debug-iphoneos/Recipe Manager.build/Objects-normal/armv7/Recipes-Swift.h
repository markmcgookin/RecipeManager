...
- (IBAction)doneButtonClick:(id __nonnull)sender;
- (IBAction)titleDoneButtonClick:(id __nonnull)sender;
- (void)handleDoneButtonState;
...
SWIFT_CLASS("_TtC7Recipes19CustomTableViewCell")
@interface CustomTableViewCell : UITableViewCell
@property (nonatomic) Recipe * __nullable CellRecipe;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC7Recipes20DetailViewController")
@interface DetailViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextView * __null_unspecified recipeContentText;
@property (nonatomic) Recipe * __nullable PreRecipe;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
...
SWIFT_CLASS("_TtC7Recipes21NSUserDefaultsManager")
@interface NSUserDefaultsManager : NSObject
+ (NSUserDefaults * __nonnull)userDefaults;
+ (void)Synchronise;
...
SWIFT_CLASS("_TtC7Recipes6Recipe")
...
- (SWIFT_NULLABILITY(nonnull) instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithTitle:(NSString * __nonnull)title content:(NSString * __nonnull)content OBJC_DESIGNATED_INITIALIZER;
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * __nonnull)aCoder;
@end


SWIFT_CLASS("_TtC7Recipes13RecipeManager")
@interface RecipeManager : NSObject
+ (NSArray * __nonnull)Recipes;
+ (void)setRecipes:(NSArray * __nonnull)value;
+ (void)AddRecipe:(NSString * __nonnull)title content:(NSString * __nonnull)content;
+ (void)DeleteRecipe:(NSInteger)id;
+ (Recipe * __nonnull)GetRecipe:(NSInteger)id;
- (SWIFT_NULLABILITY(nonnull) instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC7Recipes14ViewController")
@interface ViewController : UITableViewController
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
- (void)initializeiCloud;
- (void)updateFromiCloud:(NSNotification * __nonnull)notification;
- (void)didReceiveMemoryWarning;
...
SWIFT_CLASS("_TtC7Recipes13iCloudManager")
